...
carro.addPessoas = function(numPessoas){
  ...
  var qtPessoas = carro.assentos - carro.quantidadePessoas;
  var pluralOuSingular = carro.qtPessoas === 1 ? "pessoa" : "pessoas";
  ...
  if(totalPessoas > carro.assentos){
    return `Só cabem mais ${qtPessoas} ${pluralOuSingular}`;
  }
...
carro.obterMarcaModelo();  // 'Esse carro é um BMW 320i'
